...
from trainx import read_wav, detect_clicks, extract_features, build_feature_matrix, WINDOW_LEFT, WINDOW_RIGHT, PEAK_THRES, PEAK_DIST
...
def main():
	...
	data = prune(build_feature_matrix(signal, peaks, freq, WINDOW_LEFT, WINDOW_RIGHT))
